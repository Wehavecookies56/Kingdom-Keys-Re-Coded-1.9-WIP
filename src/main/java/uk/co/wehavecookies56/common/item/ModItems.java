...
import uk.co.wehavecookies56.common.item.org.ItemArpeggio;
import uk.co.wehavecookies56.common.item.org.ItemBlazeofGlory;
import uk.co.wehavecookies56.common.item.org.ItemBookofRetribution;
import uk.co.wehavecookies56.common.item.org.ItemEternalFlames;
import uk.co.wehavecookies56.common.item.org.ItemFairGame;
import uk.co.wehavecookies56.common.item.org.ItemFoudre;
import uk.co.wehavecookies56.common.item.org.ItemFrozenPride;
import uk.co.wehavecookies56.common.item.org.ItemGracefulDahlia;
import uk.co.wehavecookies56.common.item.org.ItemIfrit;
import uk.co.wehavecookies56.common.item.org.ItemInterdiction;
import uk.co.wehavecookies56.common.item.org.ItemLindworm;
import uk.co.wehavecookies56.common.item.org.ItemLunatic;
import uk.co.wehavecookies56.common.item.org.ItemPrometheus;
import uk.co.wehavecookies56.common.item.org.ItemSharpshooter;
import uk.co.wehavecookies56.common.item.org.ItemSkysplitter;
...
public class ModItems {
	...
	// Armour material
	public static ArmorMaterial ORGANIZATIONROBE = EnumHelper.addArmorMaterial("ORGANIZATIONROBE", Reference.MODID + ":organizationrobe", 35, new int[] { 4, 8, 5, 3 }, 15, SoundEvents.item_armor_equip_leather);
	public static ArmorMaterial TERRA = EnumHelper.addArmorMaterial("TERRA", Reference.MODID + ":terra", 35, new int[] { 5, 9, 6, 5 }, 15, SoundEvents.item_armor_equip_iron);
	public static ArmorMaterial AQUA = EnumHelper.addArmorMaterial("AQUA", Reference.MODID + ":aqua", 35, new int[] { 5, 9, 6, 5 }, 15, SoundEvents.item_armor_equip_iron);
	public static ArmorMaterial VENTUS = EnumHelper.addArmorMaterial("VENTUS", Reference.MODID + ":ventus", 35, new int[] { 5, 9, 6, 5 }, 15, SoundEvents.item_armor_equip_iron);
	public static ArmorMaterial ERAQUS = EnumHelper.addArmorMaterial("ERAQUS", Reference.MODID + ":eraqus", 35, new int[] { 5, 9, 6, 5 }, 15, SoundEvents.item_armor_equip_iron);
	...
	public static void init () {
		...
		AbaddonPlasma = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_AbaddonPlasma[0], Integer.parseInt(ConfigHandler.A_TM_AbaddonPlasma[1]), Integer.parseInt(ConfigHandler.A_TM_AbaddonPlasma[2]), Float.parseFloat(ConfigHandler.A_TM_AbaddonPlasma[3]), Float.parseFloat(ConfigHandler.A_TM_AbaddonPlasma[4]), Integer.parseInt(ConfigHandler.A_TM_AbaddonPlasma[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.AbaddonPlasma);
		AbyssalTide = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_AbyssalTide[0], Integer.parseInt(ConfigHandler.A_TM_AbyssalTide[1]), Integer.parseInt(ConfigHandler.A_TM_AbyssalTide[2]), Float.parseFloat(ConfigHandler.A_TM_AbyssalTide[3]), Float.parseFloat(ConfigHandler.A_TM_AbyssalTide[4]), Integer.parseInt(ConfigHandler.A_TM_AbyssalTide[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.AbyssalTide);
		AllforOne = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_AllforOne[0], Integer.parseInt(ConfigHandler.A_TM_AllforOne[1]), Integer.parseInt(ConfigHandler.A_TM_AllforOne[2]), Float.parseFloat(ConfigHandler.A_TM_AllforOne[3]), Float.parseFloat(ConfigHandler.A_TM_AllforOne[4]), Integer.parseInt(ConfigHandler.A_TM_AllforOne[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.AllforOne);
		AnguisForetellersKeyblade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_AnguisForetellersKeyblade[0], Integer.parseInt(ConfigHandler.A_TM_AnguisForetellersKeyblade[1]), Integer.parseInt(ConfigHandler.A_TM_AnguisForetellersKeyblade[2]), Float.parseFloat(ConfigHandler.A_TM_AnguisForetellersKeyblade[3]), Float.parseFloat(ConfigHandler.A_TM_AnguisForetellersKeyblade[4]), Integer.parseInt(ConfigHandler.A_TM_AnguisForetellersKeyblade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.AnguisForetellersKeyblade);
		AstralBlast = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_AstralBlast[0], Integer.parseInt(ConfigHandler.A_TM_AstralBlast[1]), Integer.parseInt(ConfigHandler.A_TM_AstralBlast[2]), Float.parseFloat(ConfigHandler.A_TM_AstralBlast[3]), Float.parseFloat(ConfigHandler.A_TM_AstralBlast[4]), Integer.parseInt(ConfigHandler.A_TM_AstralBlast[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.AstralBlast);
		Aubade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Aubade[0], Integer.parseInt(ConfigHandler.A_TM_Aubade[1]), Integer.parseInt(ConfigHandler.A_TM_Aubade[2]), Float.parseFloat(ConfigHandler.A_TM_Aubade[3]), Float.parseFloat(ConfigHandler.A_TM_Aubade[4]), Integer.parseInt(ConfigHandler.A_TM_Aubade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Aubade);
		BondofFlame = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_BondofFlame[0], Integer.parseInt(ConfigHandler.A_TM_BondofFlame[1]), Integer.parseInt(ConfigHandler.A_TM_BondofFlame[2]), Float.parseFloat(ConfigHandler.A_TM_BondofFlame[3]), Float.parseFloat(ConfigHandler.A_TM_BondofFlame[4]), Integer.parseInt(ConfigHandler.A_TM_BondofFlame[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.BondofFlame);
		Brightcrest = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Brightcrest[0], Integer.parseInt(ConfigHandler.A_TM_Brightcrest[1]), Integer.parseInt(ConfigHandler.A_TM_Brightcrest[2]), Float.parseFloat(ConfigHandler.A_TM_Brightcrest[3]), Float.parseFloat(ConfigHandler.A_TM_Brightcrest[4]), Integer.parseInt(ConfigHandler.A_TM_Brightcrest[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Brightcrest);
		ChaosRipper = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_ChaosRipper[0], Integer.parseInt(ConfigHandler.A_TM_ChaosRipper[1]), Integer.parseInt(ConfigHandler.A_TM_ChaosRipper[2]), Float.parseFloat(ConfigHandler.A_TM_ChaosRipper[3]), Float.parseFloat(ConfigHandler.A_TM_ChaosRipper[4]), Integer.parseInt(ConfigHandler.A_TM_ChaosRipper[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.ChaosRipper);
		CircleofLife = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_CircleofLife[0], Integer.parseInt(ConfigHandler.A_TM_CircleofLife[1]), Integer.parseInt(ConfigHandler.A_TM_CircleofLife[2]), Float.parseFloat(ConfigHandler.A_TM_CircleofLife[3]), Float.parseFloat(ConfigHandler.A_TM_CircleofLife[4]), Integer.parseInt(ConfigHandler.A_TM_CircleofLife[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.CircleofLife);
		Counterpoint = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Counterpoint[0], Integer.parseInt(ConfigHandler.A_TM_Counterpoint[1]), Integer.parseInt(ConfigHandler.A_TM_Counterpoint[2]), Float.parseFloat(ConfigHandler.A_TM_Counterpoint[3]), Float.parseFloat(ConfigHandler.A_TM_Counterpoint[4]), Integer.parseInt(ConfigHandler.A_TM_Counterpoint[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Counterpoint);
		Crabclaw = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Crabclaw[0], Integer.parseInt(ConfigHandler.A_TM_Crabclaw[1]), Integer.parseInt(ConfigHandler.A_TM_Crabclaw[2]), Float.parseFloat(ConfigHandler.A_TM_Crabclaw[3]), Float.parseFloat(ConfigHandler.A_TM_Crabclaw[4]), Integer.parseInt(ConfigHandler.A_TM_Crabclaw[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Crabclaw);
		CrownofGuilt = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_CrownofGuilt[0], Integer.parseInt(ConfigHandler.A_TM_CrownofGuilt[1]), Integer.parseInt(ConfigHandler.A_TM_CrownofGuilt[2]), Float.parseFloat(ConfigHandler.A_TM_CrownofGuilt[3]), Float.parseFloat(ConfigHandler.A_TM_CrownofGuilt[4]), Integer.parseInt(ConfigHandler.A_TM_CrownofGuilt[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.CrownofGuilt);
		DarkerThanDark = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_DarkerThanDark[0], Integer.parseInt(ConfigHandler.A_TM_DarkerThanDark[1]), Integer.parseInt(ConfigHandler.A_TM_DarkerThanDark[2]), Float.parseFloat(ConfigHandler.A_TM_DarkerThanDark[3]), Float.parseFloat(ConfigHandler.A_TM_DarkerThanDark[4]), Integer.parseInt(ConfigHandler.A_TM_DarkerThanDark[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.DarkerThanDark);
		Darkgnaw = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Darkgnaw[0], Integer.parseInt(ConfigHandler.A_TM_Darkgnaw[1]), Integer.parseInt(ConfigHandler.A_TM_Darkgnaw[2]), Float.parseFloat(ConfigHandler.A_TM_Darkgnaw[3]), Float.parseFloat(ConfigHandler.A_TM_Darkgnaw[4]), Integer.parseInt(ConfigHandler.A_TM_Darkgnaw[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Darkgnaw);
		DecisivePumpkin = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_DecisivePumpkin[0], Integer.parseInt(ConfigHandler.A_TM_DecisivePumpkin[1]), Integer.parseInt(ConfigHandler.A_TM_DecisivePumpkin[2]), Float.parseFloat(ConfigHandler.A_TM_DecisivePumpkin[3]), Float.parseFloat(ConfigHandler.A_TM_DecisivePumpkin[4]), Integer.parseInt(ConfigHandler.A_TM_DecisivePumpkin[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.DecisivePumpkin);
		DestinysEmbrace = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_DestinysEmbrace[0], Integer.parseInt(ConfigHandler.A_TM_DestinysEmbrace[1]), Integer.parseInt(ConfigHandler.A_TM_DestinysEmbrace[2]), Float.parseFloat(ConfigHandler.A_TM_DestinysEmbrace[3]), Float.parseFloat(ConfigHandler.A_TM_DestinysEmbrace[4]), Integer.parseInt(ConfigHandler.A_TM_DestinysEmbrace[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.DestinysEmbrace);
		DiamondDust = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_DiamondDust[0], Integer.parseInt(ConfigHandler.A_TM_DiamondDust[1]), Integer.parseInt(ConfigHandler.A_TM_DiamondDust[2]), Float.parseFloat(ConfigHandler.A_TM_DiamondDust[3]), Float.parseFloat(ConfigHandler.A_TM_DiamondDust[4]), Integer.parseInt(ConfigHandler.A_TM_DiamondDust[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.DiamondDust);
		Divewing = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Divewing[0], Integer.parseInt(ConfigHandler.A_TM_Divewing[1]), Integer.parseInt(ConfigHandler.A_TM_Divewing[2]), Float.parseFloat(ConfigHandler.A_TM_Divewing[3]), Float.parseFloat(ConfigHandler.A_TM_Divewing[4]), Integer.parseInt(ConfigHandler.A_TM_Divewing[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Divewing);
		DivineRose = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_DivineRose[0], Integer.parseInt(ConfigHandler.A_TM_DivineRose[1]), Integer.parseInt(ConfigHandler.A_TM_DivineRose[2]), Float.parseFloat(ConfigHandler.A_TM_DivineRose[3]), Float.parseFloat(ConfigHandler.A_TM_DivineRose[4]), Integer.parseInt(ConfigHandler.A_TM_DivineRose[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.DivineRose);
		...
		DualDisc = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_DualDisc[0], Integer.parseInt(ConfigHandler.A_TM_DualDisc[1]), Integer.parseInt(ConfigHandler.A_TM_DualDisc[2]), Float.parseFloat(ConfigHandler.A_TM_DualDisc[3]), Float.parseFloat(ConfigHandler.A_TM_DualDisc[4]), Integer.parseInt(ConfigHandler.A_TM_DualDisc[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.DualDisc);
		Earthshaker = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Earthshaker[0], Integer.parseInt(ConfigHandler.A_TM_Earthshaker[1]), Integer.parseInt(ConfigHandler.A_TM_Earthshaker[2]), Float.parseFloat(ConfigHandler.A_TM_Earthshaker[3]), Float.parseFloat(ConfigHandler.A_TM_Earthshaker[4]), Integer.parseInt(ConfigHandler.A_TM_Earthshaker[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Earthshaker);
		EndofPain = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_EndofPain[0], Integer.parseInt(ConfigHandler.A_TM_EndofPain[1]), Integer.parseInt(ConfigHandler.A_TM_EndofPain[2]), Float.parseFloat(ConfigHandler.A_TM_EndofPain[3]), Float.parseFloat(ConfigHandler.A_TM_EndofPain[4]), Integer.parseInt(ConfigHandler.A_TM_EndofPain[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.EndofPain);
		EndsoftheEarth = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_EndsoftheEarth[0], Integer.parseInt(ConfigHandler.A_TM_EndsoftheEarth[1]), Integer.parseInt(ConfigHandler.A_TM_EndsoftheEarth[2]), Float.parseFloat(ConfigHandler.A_TM_EndsoftheEarth[3]), Float.parseFloat(ConfigHandler.A_TM_EndsoftheEarth[4]), Integer.parseInt(ConfigHandler.A_TM_EndsoftheEarth[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.EndsoftheEarth);
		FairyHarp = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_FairyHarp[0], Integer.parseInt(ConfigHandler.A_TM_FairyHarp[1]), Integer.parseInt(ConfigHandler.A_TM_FairyHarp[2]), Float.parseFloat(ConfigHandler.A_TM_FairyHarp[3]), Float.parseFloat(ConfigHandler.A_TM_FairyHarp[4]), Integer.parseInt(ConfigHandler.A_TM_FairyHarp[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.FairyHarp);
		FairyStars = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_FairyStars[0], Integer.parseInt(ConfigHandler.A_TM_FairyStars[1]), Integer.parseInt(ConfigHandler.A_TM_FairyStars[2]), Float.parseFloat(ConfigHandler.A_TM_FairyStars[3]), Float.parseFloat(ConfigHandler.A_TM_FairyStars[4]), Integer.parseInt(ConfigHandler.A_TM_FairyStars[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.FairyStars);
		FatalCrest = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_FatalCrest[0], Integer.parseInt(ConfigHandler.A_TM_FatalCrest[1]), Integer.parseInt(ConfigHandler.A_TM_FatalCrest[2]), Float.parseFloat(ConfigHandler.A_TM_FatalCrest[3]), Float.parseFloat(ConfigHandler.A_TM_FatalCrest[4]), Integer.parseInt(ConfigHandler.A_TM_FatalCrest[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.FatalCrest);
		Fenrir = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Fenrir[0], Integer.parseInt(ConfigHandler.A_TM_Fenrir[1]), Integer.parseInt(ConfigHandler.A_TM_Fenrir[2]), Float.parseFloat(ConfigHandler.A_TM_Fenrir[3]), Float.parseFloat(ConfigHandler.A_TM_Fenrir[4]), Integer.parseInt(ConfigHandler.A_TM_Fenrir[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Fenrir);
		FerrisGear = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_FerrisGear[0], Integer.parseInt(ConfigHandler.A_TM_FerrisGear[1]), Integer.parseInt(ConfigHandler.A_TM_FerrisGear[2]), Float.parseFloat(ConfigHandler.A_TM_FerrisGear[3]), Float.parseFloat(ConfigHandler.A_TM_FerrisGear[4]), Integer.parseInt(ConfigHandler.A_TM_FerrisGear[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.FerrisGear);
		FollowtheWind = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_FollowtheWind[0], Integer.parseInt(ConfigHandler.A_TM_FollowtheWind[1]), Integer.parseInt(ConfigHandler.A_TM_FollowtheWind[2]), Float.parseFloat(ConfigHandler.A_TM_FollowtheWind[3]), Float.parseFloat(ConfigHandler.A_TM_FollowtheWind[4]), Integer.parseInt(ConfigHandler.A_TM_FollowtheWind[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.FollowtheWind);
		FrolicFlame = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_FrolicFlame[0], Integer.parseInt(ConfigHandler.A_TM_FrolicFlame[1]), Integer.parseInt(ConfigHandler.A_TM_FrolicFlame[2]), Float.parseFloat(ConfigHandler.A_TM_FrolicFlame[3]), Float.parseFloat(ConfigHandler.A_TM_FrolicFlame[4]), Integer.parseInt(ConfigHandler.A_TM_FrolicFlame[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.FrolicFlame);
		GlimpseofDarkness = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_GlimpseofDarkness[0], Integer.parseInt(ConfigHandler.A_TM_GlimpseofDarkness[1]), Integer.parseInt(ConfigHandler.A_TM_GlimpseofDarkness[2]), Float.parseFloat(ConfigHandler.A_TM_GlimpseofDarkness[3]), Float.parseFloat(ConfigHandler.A_TM_GlimpseofDarkness[4]), Integer.parseInt(ConfigHandler.A_TM_GlimpseofDarkness[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.GlimpseofDarkness);
		GuardianBell = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_GuardianBell[0], Integer.parseInt(ConfigHandler.A_TM_GuardianBell[1]), Integer.parseInt(ConfigHandler.A_TM_GuardianBell[2]), Float.parseFloat(ConfigHandler.A_TM_GuardianBell[3]), Float.parseFloat(ConfigHandler.A_TM_GuardianBell[4]), Integer.parseInt(ConfigHandler.A_TM_GuardianBell[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.GuardianBell);
		GuardianSoul = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_GuardianSoul[0], Integer.parseInt(ConfigHandler.A_TM_GuardianSoul[1]), Integer.parseInt(ConfigHandler.A_TM_GuardianSoul[2]), Float.parseFloat(ConfigHandler.A_TM_GuardianSoul[3]), Float.parseFloat(ConfigHandler.A_TM_GuardianSoul[4]), Integer.parseInt(ConfigHandler.A_TM_GuardianSoul[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.GuardianSoul);
		GullWing = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_GullWing[0], Integer.parseInt(ConfigHandler.A_TM_GullWing[1]), Integer.parseInt(ConfigHandler.A_TM_GullWing[2]), Float.parseFloat(ConfigHandler.A_TM_GullWing[3]), Float.parseFloat(ConfigHandler.A_TM_GullWing[4]), Integer.parseInt(ConfigHandler.A_TM_GullWing[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.GullWing);
		HerosCrest = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_HerosCrest[0], Integer.parseInt(ConfigHandler.A_TM_HerosCrest[1]), Integer.parseInt(ConfigHandler.A_TM_HerosCrest[2]), Float.parseFloat(ConfigHandler.A_TM_HerosCrest[3]), Float.parseFloat(ConfigHandler.A_TM_HerosCrest[4]), Integer.parseInt(ConfigHandler.A_TM_HerosCrest[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.HerosCrest);
		HiddenDragon = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_HiddenDragon[0], Integer.parseInt(ConfigHandler.A_TM_HiddenDragon[1]), Integer.parseInt(ConfigHandler.A_TM_HiddenDragon[2]), Float.parseFloat(ConfigHandler.A_TM_HiddenDragon[3]), Float.parseFloat(ConfigHandler.A_TM_HiddenDragon[4]), Integer.parseInt(ConfigHandler.A_TM_HiddenDragon[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.HiddenDragon);
		Hyperdrive = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Hyperdrive[0], Integer.parseInt(ConfigHandler.A_TM_Hyperdrive[1]), Integer.parseInt(ConfigHandler.A_TM_Hyperdrive[2]), Float.parseFloat(ConfigHandler.A_TM_Hyperdrive[3]), Float.parseFloat(ConfigHandler.A_TM_Hyperdrive[4]), Integer.parseInt(ConfigHandler.A_TM_Hyperdrive[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Hyperdrive);
		IncompleteKiblade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_IncompleteKiblade[0], Integer.parseInt(ConfigHandler.A_TM_IncompleteKiblade[1]), Integer.parseInt(ConfigHandler.A_TM_IncompleteKiblade[2]), Float.parseFloat(ConfigHandler.A_TM_IncompleteKiblade[3]), Float.parseFloat(ConfigHandler.A_TM_IncompleteKiblade[4]), Integer.parseInt(ConfigHandler.A_TM_IncompleteKiblade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.IncompleteKiblade);
		JungleKing = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_JungleKing[0], Integer.parseInt(ConfigHandler.A_TM_JungleKing[1]), Integer.parseInt(ConfigHandler.A_TM_JungleKing[2]), Float.parseFloat(ConfigHandler.A_TM_JungleKing[3]), Float.parseFloat(ConfigHandler.A_TM_JungleKing[4]), Integer.parseInt(ConfigHandler.A_TM_JungleKing[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.JungleKing);
		KeybladeofPeoplesHearts = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_KeybladeofPeoplesHearts[0], Integer.parseInt(ConfigHandler.A_TM_KeybladeofPeoplesHearts[1]), Integer.parseInt(ConfigHandler.A_TM_KeybladeofPeoplesHearts[2]), Float.parseFloat(ConfigHandler.A_TM_KeybladeofPeoplesHearts[3]), Float.parseFloat(ConfigHandler.A_TM_KeybladeofPeoplesHearts[4]), Integer.parseInt(ConfigHandler.A_TM_KeybladeofPeoplesHearts[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.KeybladeofPeoplesHearts);
		Kiblade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Kiblade[0], Integer.parseInt(ConfigHandler.A_TM_Kiblade[1]), Integer.parseInt(ConfigHandler.A_TM_Kiblade[2]), Float.parseFloat(ConfigHandler.A_TM_Kiblade[3]), Float.parseFloat(ConfigHandler.A_TM_Kiblade[4]), Integer.parseInt(ConfigHandler.A_TM_Kiblade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Kiblade);
		KingdomKey = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_KingdomKey[0], Integer.parseInt(ConfigHandler.A_TM_KingdomKey[1]), Integer.parseInt(ConfigHandler.A_TM_KingdomKey[2]), Float.parseFloat(ConfigHandler.A_TM_KingdomKey[3]), Float.parseFloat(ConfigHandler.A_TM_KingdomKey[4]), Integer.parseInt(ConfigHandler.A_TM_KingdomKey[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.KingdomKey);
		KingdomKeyD = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_KingdomKeyD[0], Integer.parseInt(ConfigHandler.A_TM_KingdomKeyD[1]), Integer.parseInt(ConfigHandler.A_TM_KingdomKeyD[2]), Float.parseFloat(ConfigHandler.A_TM_KingdomKeyD[3]), Float.parseFloat(ConfigHandler.A_TM_KingdomKeyD[4]), Integer.parseInt(ConfigHandler.A_TM_KingdomKeyD[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.KingdomKeyD);
		KnockoutPunch = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_KnockoutPunch[0], Integer.parseInt(ConfigHandler.A_TM_KnockoutPunch[1]), Integer.parseInt(ConfigHandler.A_TM_KnockoutPunch[2]), Float.parseFloat(ConfigHandler.A_TM_KnockoutPunch[3]), Float.parseFloat(ConfigHandler.A_TM_KnockoutPunch[4]), Integer.parseInt(ConfigHandler.A_TM_KnockoutPunch[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.KnockoutPunch);
		LadyLuck = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_LadyLuck[0], Integer.parseInt(ConfigHandler.A_TM_LadyLuck[1]), Integer.parseInt(ConfigHandler.A_TM_LadyLuck[2]), Float.parseFloat(ConfigHandler.A_TM_LadyLuck[3]), Float.parseFloat(ConfigHandler.A_TM_LadyLuck[4]), Integer.parseInt(ConfigHandler.A_TM_LadyLuck[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.LadyLuck);
		LeasKeyblade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_LeasKeyblade[0], Integer.parseInt(ConfigHandler.A_TM_LeasKeyblade[1]), Integer.parseInt(ConfigHandler.A_TM_LeasKeyblade[2]), Float.parseFloat(ConfigHandler.A_TM_LeasKeyblade[3]), Float.parseFloat(ConfigHandler.A_TM_LeasKeyblade[4]), Integer.parseInt(ConfigHandler.A_TM_LeasKeyblade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.LeasKeyblade);
		LeopardosForetellersKeyblade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_LeopardosForetellersKeyblade[0], Integer.parseInt(ConfigHandler.A_TM_LeopardosForetellersKeyblade[1]), Integer.parseInt(ConfigHandler.A_TM_LeopardosForetellersKeyblade[2]), Float.parseFloat(ConfigHandler.A_TM_LeopardosForetellersKeyblade[3]), Float.parseFloat(ConfigHandler.A_TM_LeopardosForetellersKeyblade[4]), Integer.parseInt(ConfigHandler.A_TM_LeopardosForetellersKeyblade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.LeopardosForetellersKeyblade);
		Leviathan = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Leviathan[0], Integer.parseInt(ConfigHandler.A_TM_Leviathan[1]), Integer.parseInt(ConfigHandler.A_TM_Leviathan[2]), Float.parseFloat(ConfigHandler.A_TM_Leviathan[3]), Float.parseFloat(ConfigHandler.A_TM_Leviathan[4]), Integer.parseInt(ConfigHandler.A_TM_Leviathan[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Leviathan);
		Lionheart = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Lionheart[0], Integer.parseInt(ConfigHandler.A_TM_Lionheart[1]), Integer.parseInt(ConfigHandler.A_TM_Lionheart[2]), Float.parseFloat(ConfigHandler.A_TM_Lionheart[3]), Float.parseFloat(ConfigHandler.A_TM_Lionheart[4]), Integer.parseInt(ConfigHandler.A_TM_Lionheart[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Lionheart);
		LostMemory = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_LostMemory[0], Integer.parseInt(ConfigHandler.A_TM_LostMemory[1]), Integer.parseInt(ConfigHandler.A_TM_LostMemory[2]), Float.parseFloat(ConfigHandler.A_TM_LostMemory[3]), Float.parseFloat(ConfigHandler.A_TM_LostMemory[4]), Integer.parseInt(ConfigHandler.A_TM_LostMemory[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.LostMemory);
		LunarEclipse = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_LunarEclipse[0], Integer.parseInt(ConfigHandler.A_TM_LunarEclipse[1]), Integer.parseInt(ConfigHandler.A_TM_LunarEclipse[2]), Float.parseFloat(ConfigHandler.A_TM_LunarEclipse[3]), Float.parseFloat(ConfigHandler.A_TM_LunarEclipse[4]), Integer.parseInt(ConfigHandler.A_TM_LunarEclipse[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.LunarEclipse);
		MarkofaHero = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_MarkofaHero[0], Integer.parseInt(ConfigHandler.A_TM_MarkofaHero[1]), Integer.parseInt(ConfigHandler.A_TM_MarkofaHero[2]), Float.parseFloat(ConfigHandler.A_TM_MarkofaHero[3]), Float.parseFloat(ConfigHandler.A_TM_MarkofaHero[4]), Integer.parseInt(ConfigHandler.A_TM_MarkofaHero[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.MarkofaHero);
		MasterXehanortsKeyblade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_MasterXehanortsKeyblade[0], Integer.parseInt(ConfigHandler.A_TM_MasterXehanortsKeyblade[1]), Integer.parseInt(ConfigHandler.A_TM_MasterXehanortsKeyblade[2]), Float.parseFloat(ConfigHandler.A_TM_MasterXehanortsKeyblade[3]), Float.parseFloat(ConfigHandler.A_TM_MasterXehanortsKeyblade[4]), Integer.parseInt(ConfigHandler.A_TM_MasterXehanortsKeyblade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.MasterXehanortsKeyblade);
		MastersDefender = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_MastersDefender[0], Integer.parseInt(ConfigHandler.A_TM_MastersDefender[1]), Integer.parseInt(ConfigHandler.A_TM_MastersDefender[2]), Float.parseFloat(ConfigHandler.A_TM_MastersDefender[3]), Float.parseFloat(ConfigHandler.A_TM_MastersDefender[4]), Integer.parseInt(ConfigHandler.A_TM_MastersDefender[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.MastersDefender);
		MaverickFlare = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_MaverickFlare[0], Integer.parseInt(ConfigHandler.A_TM_MaverickFlare[1]), Integer.parseInt(ConfigHandler.A_TM_MaverickFlare[2]), Float.parseFloat(ConfigHandler.A_TM_MaverickFlare[3]), Float.parseFloat(ConfigHandler.A_TM_MaverickFlare[4]), Integer.parseInt(ConfigHandler.A_TM_MaverickFlare[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.MaverickFlare);
		MetalChocobo = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_MetalChocobo[0], Integer.parseInt(ConfigHandler.A_TM_MetalChocobo[1]), Integer.parseInt(ConfigHandler.A_TM_MetalChocobo[2]), Float.parseFloat(ConfigHandler.A_TM_MetalChocobo[3]), Float.parseFloat(ConfigHandler.A_TM_MetalChocobo[4]), Integer.parseInt(ConfigHandler.A_TM_MetalChocobo[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.MetalChocobo);
		MidnightRoar = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_MidnightRoar[0], Integer.parseInt(ConfigHandler.A_TM_MidnightRoar[1]), Integer.parseInt(ConfigHandler.A_TM_MidnightRoar[2]), Float.parseFloat(ConfigHandler.A_TM_MidnightRoar[3]), Float.parseFloat(ConfigHandler.A_TM_MidnightRoar[4]), Integer.parseInt(ConfigHandler.A_TM_MidnightRoar[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.MidnightRoar);
		MirageSplit = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_MirageSplit[0], Integer.parseInt(ConfigHandler.A_TM_MirageSplit[1]), Integer.parseInt(ConfigHandler.A_TM_MirageSplit[2]), Float.parseFloat(ConfigHandler.A_TM_MirageSplit[3]), Float.parseFloat(ConfigHandler.A_TM_MirageSplit[4]), Integer.parseInt(ConfigHandler.A_TM_MirageSplit[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.MirageSplit);
		MissingAche = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_MissingAche[0], Integer.parseInt(ConfigHandler.A_TM_MissingAche[1]), Integer.parseInt(ConfigHandler.A_TM_MissingAche[2]), Float.parseFloat(ConfigHandler.A_TM_MissingAche[3]), Float.parseFloat(ConfigHandler.A_TM_MissingAche[4]), Integer.parseInt(ConfigHandler.A_TM_MissingAche[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.MissingAche);
		Monochrome = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Monochrome[0], Integer.parseInt(ConfigHandler.A_TM_Monochrome[1]), Integer.parseInt(ConfigHandler.A_TM_Monochrome[2]), Float.parseFloat(ConfigHandler.A_TM_Monochrome[3]), Float.parseFloat(ConfigHandler.A_TM_Monochrome[4]), Integer.parseInt(ConfigHandler.A_TM_Monochrome[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Monochrome);
		MysteriousAbyss = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_MysteriousAbyss[0], Integer.parseInt(ConfigHandler.A_TM_MysteriousAbyss[1]), Integer.parseInt(ConfigHandler.A_TM_MysteriousAbyss[2]), Float.parseFloat(ConfigHandler.A_TM_MysteriousAbyss[3]), Float.parseFloat(ConfigHandler.A_TM_MysteriousAbyss[4]), Integer.parseInt(ConfigHandler.A_TM_MysteriousAbyss[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.MysteriousAbyss);
		NightmaresEnd = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_NightmaresEnd[0], Integer.parseInt(ConfigHandler.A_TM_NightmaresEnd[1]), Integer.parseInt(ConfigHandler.A_TM_NightmaresEnd[2]), Float.parseFloat(ConfigHandler.A_TM_NightmaresEnd[3]), Float.parseFloat(ConfigHandler.A_TM_NightmaresEnd[4]), Integer.parseInt(ConfigHandler.A_TM_NightmaresEnd[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.NightmaresEnd);
		NightmaresEndandMirageSplit = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_NightmaresEndandMirageSplit[0], Integer.parseInt(ConfigHandler.A_TM_NightmaresEndandMirageSplit[1]), Integer.parseInt(ConfigHandler.A_TM_NightmaresEndandMirageSplit[2]), Float.parseFloat(ConfigHandler.A_TM_NightmaresEndandMirageSplit[3]), Float.parseFloat(ConfigHandler.A_TM_NightmaresEndandMirageSplit[4]), Integer.parseInt(ConfigHandler.A_TM_NightmaresEndandMirageSplit[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.NightmaresEndandMirageSplit);
		NoName = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_NoName[0], Integer.parseInt(ConfigHandler.A_TM_NoName[1]), Integer.parseInt(ConfigHandler.A_TM_NoName[2]), Float.parseFloat(ConfigHandler.A_TM_NoName[3]), Float.parseFloat(ConfigHandler.A_TM_NoName[4]), Integer.parseInt(ConfigHandler.A_TM_NoName[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.NoName);
		Oathkeeper = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Oathkeeper[0], Integer.parseInt(ConfigHandler.A_TM_Oathkeeper[1]), Integer.parseInt(ConfigHandler.A_TM_Oathkeeper[2]), Float.parseFloat(ConfigHandler.A_TM_Oathkeeper[3]), Float.parseFloat(ConfigHandler.A_TM_Oathkeeper[4]), Integer.parseInt(ConfigHandler.A_TM_Oathkeeper[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Oathkeeper);
		Oblivion = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Oblivion[0], Integer.parseInt(ConfigHandler.A_TM_Oblivion[1]), Integer.parseInt(ConfigHandler.A_TM_Oblivion[2]), Float.parseFloat(ConfigHandler.A_TM_Oblivion[3]), Float.parseFloat(ConfigHandler.A_TM_Oblivion[4]), Integer.parseInt(ConfigHandler.A_TM_Oblivion[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Oblivion);
		OceansRage = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_OceansRage[0], Integer.parseInt(ConfigHandler.A_TM_OceansRage[1]), Integer.parseInt(ConfigHandler.A_TM_OceansRage[2]), Float.parseFloat(ConfigHandler.A_TM_OceansRage[3]), Float.parseFloat(ConfigHandler.A_TM_OceansRage[4]), Integer.parseInt(ConfigHandler.A_TM_OceansRage[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.OceansRage);
		Olympia = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Olympia[0], Integer.parseInt(ConfigHandler.A_TM_Olympia[1]), Integer.parseInt(ConfigHandler.A_TM_Olympia[2]), Float.parseFloat(ConfigHandler.A_TM_Olympia[3]), Float.parseFloat(ConfigHandler.A_TM_Olympia[4]), Integer.parseInt(ConfigHandler.A_TM_Olympia[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Olympia);
		OmegaWeapon = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_OmegaWeapon[0], Integer.parseInt(ConfigHandler.A_TM_OmegaWeapon[1]), Integer.parseInt(ConfigHandler.A_TM_OmegaWeapon[2]), Float.parseFloat(ConfigHandler.A_TM_OmegaWeapon[3]), Float.parseFloat(ConfigHandler.A_TM_OmegaWeapon[4]), Integer.parseInt(ConfigHandler.A_TM_OmegaWeapon[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.OmegaWeapon);
		OminousBlight = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_OminousBlight[0], Integer.parseInt(ConfigHandler.A_TM_OminousBlight[1]), Integer.parseInt(ConfigHandler.A_TM_OminousBlight[2]), Float.parseFloat(ConfigHandler.A_TM_OminousBlight[3]), Float.parseFloat(ConfigHandler.A_TM_OminousBlight[4]), Integer.parseInt(ConfigHandler.A_TM_OminousBlight[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.OminousBlight);
		OneWingedAngel = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_OneWingedAngel[0], Integer.parseInt(ConfigHandler.A_TM_OneWingedAngel[1]), Integer.parseInt(ConfigHandler.A_TM_OneWingedAngel[2]), Float.parseFloat(ConfigHandler.A_TM_OneWingedAngel[3]), Float.parseFloat(ConfigHandler.A_TM_OneWingedAngel[4]), Integer.parseInt(ConfigHandler.A_TM_OneWingedAngel[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.OneWingedAngel);
		PainofSolitude = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_PainofSolitude[0], Integer.parseInt(ConfigHandler.A_TM_PainofSolitude[1]), Integer.parseInt(ConfigHandler.A_TM_PainofSolitude[2]), Float.parseFloat(ConfigHandler.A_TM_PainofSolitude[3]), Float.parseFloat(ConfigHandler.A_TM_PainofSolitude[4]), Integer.parseInt(ConfigHandler.A_TM_PainofSolitude[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.PainofSolitude);
		PhotonDebugger = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_PhotonDebugger[0], Integer.parseInt(ConfigHandler.A_TM_PhotonDebugger[1]), Integer.parseInt(ConfigHandler.A_TM_PhotonDebugger[2]), Float.parseFloat(ConfigHandler.A_TM_PhotonDebugger[3]), Float.parseFloat(ConfigHandler.A_TM_PhotonDebugger[4]), Integer.parseInt(ConfigHandler.A_TM_PhotonDebugger[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.PhotonDebugger);
		PixiePetal = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_PixiePetal[0], Integer.parseInt(ConfigHandler.A_TM_PixiePetal[1]), Integer.parseInt(ConfigHandler.A_TM_PixiePetal[2]), Float.parseFloat(ConfigHandler.A_TM_PixiePetal[3]), Float.parseFloat(ConfigHandler.A_TM_PixiePetal[4]), Integer.parseInt(ConfigHandler.A_TM_PixiePetal[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.PixiePetal);
		Pumpkinhead = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Pumpkinhead[0], Integer.parseInt(ConfigHandler.A_TM_Pumpkinhead[1]), Integer.parseInt(ConfigHandler.A_TM_Pumpkinhead[2]), Float.parseFloat(ConfigHandler.A_TM_Pumpkinhead[3]), Float.parseFloat(ConfigHandler.A_TM_Pumpkinhead[4]), Integer.parseInt(ConfigHandler.A_TM_Pumpkinhead[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Pumpkinhead);
		Rainfell = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Rainfell[0], Integer.parseInt(ConfigHandler.A_TM_Rainfell[1]), Integer.parseInt(ConfigHandler.A_TM_Rainfell[2]), Float.parseFloat(ConfigHandler.A_TM_Rainfell[3]), Float.parseFloat(ConfigHandler.A_TM_Rainfell[4]), Integer.parseInt(ConfigHandler.A_TM_Rainfell[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Rainfell);
		RejectionofFate = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_RejectionofFate[0], Integer.parseInt(ConfigHandler.A_TM_RejectionofFate[1]), Integer.parseInt(ConfigHandler.A_TM_RejectionofFate[2]), Float.parseFloat(ConfigHandler.A_TM_RejectionofFate[3]), Float.parseFloat(ConfigHandler.A_TM_RejectionofFate[4]), Integer.parseInt(ConfigHandler.A_TM_RejectionofFate[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.RejectionofFate);
		RoyalRadiance = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_RoyalRadiance[0], Integer.parseInt(ConfigHandler.A_TM_RoyalRadiance[1]), Integer.parseInt(ConfigHandler.A_TM_RoyalRadiance[2]), Float.parseFloat(ConfigHandler.A_TM_RoyalRadiance[3]), Float.parseFloat(ConfigHandler.A_TM_RoyalRadiance[4]), Integer.parseInt(ConfigHandler.A_TM_RoyalRadiance[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.RoyalRadiance);
		RumblingRose = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_RumblingRose[0], Integer.parseInt(ConfigHandler.A_TM_RumblingRose[1]), Integer.parseInt(ConfigHandler.A_TM_RumblingRose[2]), Float.parseFloat(ConfigHandler.A_TM_RumblingRose[3]), Float.parseFloat(ConfigHandler.A_TM_RumblingRose[4]), Integer.parseInt(ConfigHandler.A_TM_RumblingRose[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.RumblingRose);
		SignofInnocence = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_SignofInnocence[0], Integer.parseInt(ConfigHandler.A_TM_SignofInnocence[1]), Integer.parseInt(ConfigHandler.A_TM_SignofInnocence[2]), Float.parseFloat(ConfigHandler.A_TM_SignofInnocence[3]), Float.parseFloat(ConfigHandler.A_TM_SignofInnocence[4]), Integer.parseInt(ConfigHandler.A_TM_SignofInnocence[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.SignofInnocence);
		SilentDirge = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_SilentDirge[0], Integer.parseInt(ConfigHandler.A_TM_SilentDirge[1]), Integer.parseInt(ConfigHandler.A_TM_SilentDirge[2]), Float.parseFloat(ConfigHandler.A_TM_SilentDirge[3]), Float.parseFloat(ConfigHandler.A_TM_SilentDirge[4]), Integer.parseInt(ConfigHandler.A_TM_SilentDirge[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.SilentDirge);
		SkullNoise = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_SkullNoise[0], Integer.parseInt(ConfigHandler.A_TM_SkullNoise[1]), Integer.parseInt(ConfigHandler.A_TM_SkullNoise[2]), Float.parseFloat(ConfigHandler.A_TM_SkullNoise[3]), Float.parseFloat(ConfigHandler.A_TM_SkullNoise[4]), Integer.parseInt(ConfigHandler.A_TM_SkullNoise[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.SkullNoise);
		SleepingLion = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_SleepingLion[0], Integer.parseInt(ConfigHandler.A_TM_SleepingLion[1]), Integer.parseInt(ConfigHandler.A_TM_SleepingLion[2]), Float.parseFloat(ConfigHandler.A_TM_SleepingLion[3]), Float.parseFloat(ConfigHandler.A_TM_SleepingLion[4]), Integer.parseInt(ConfigHandler.A_TM_SleepingLion[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.SleepingLion);
		SoulEater = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_SoulEater[0], Integer.parseInt(ConfigHandler.A_TM_SoulEater[1]), Integer.parseInt(ConfigHandler.A_TM_SoulEater[2]), Float.parseFloat(ConfigHandler.A_TM_SoulEater[3]), Float.parseFloat(ConfigHandler.A_TM_SoulEater[4]), Integer.parseInt(ConfigHandler.A_TM_SoulEater[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.SoulEater);
		Spellbinder = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Spellbinder[0], Integer.parseInt(ConfigHandler.A_TM_Spellbinder[1]), Integer.parseInt(ConfigHandler.A_TM_Spellbinder[2]), Float.parseFloat(ConfigHandler.A_TM_Spellbinder[3]), Float.parseFloat(ConfigHandler.A_TM_Spellbinder[4]), Integer.parseInt(ConfigHandler.A_TM_Spellbinder[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Spellbinder);
		Starlight = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Starlight[0], Integer.parseInt(ConfigHandler.A_TM_Starlight[1]), Integer.parseInt(ConfigHandler.A_TM_Starlight[2]), Float.parseFloat(ConfigHandler.A_TM_Starlight[3]), Float.parseFloat(ConfigHandler.A_TM_Starlight[4]), Integer.parseInt(ConfigHandler.A_TM_Starlight[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Starlight);
		StarSeeker = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_StarSeeker[0], Integer.parseInt(ConfigHandler.A_TM_StarSeeker[1]), Integer.parseInt(ConfigHandler.A_TM_StarSeeker[2]), Float.parseFloat(ConfigHandler.A_TM_StarSeeker[3]), Float.parseFloat(ConfigHandler.A_TM_StarSeeker[4]), Integer.parseInt(ConfigHandler.A_TM_StarSeeker[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.StarSeeker);
		Stormfall = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Stormfall[0], Integer.parseInt(ConfigHandler.A_TM_Stormfall[1]), Integer.parseInt(ConfigHandler.A_TM_Stormfall[2]), Float.parseFloat(ConfigHandler.A_TM_Stormfall[3]), Float.parseFloat(ConfigHandler.A_TM_Stormfall[4]), Integer.parseInt(ConfigHandler.A_TM_Stormfall[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Stormfall);
		StrokeofMidnight = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_StrokeofMidnight[0], Integer.parseInt(ConfigHandler.A_TM_StrokeofMidnight[1]), Integer.parseInt(ConfigHandler.A_TM_StrokeofMidnight[2]), Float.parseFloat(ConfigHandler.A_TM_StrokeofMidnight[3]), Float.parseFloat(ConfigHandler.A_TM_StrokeofMidnight[4]), Integer.parseInt(ConfigHandler.A_TM_StrokeofMidnight[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.StrokeofMidnight);
		SweetDreams = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_SweetDreams[0], Integer.parseInt(ConfigHandler.A_TM_SweetDreams[1]), Integer.parseInt(ConfigHandler.A_TM_SweetDreams[2]), Float.parseFloat(ConfigHandler.A_TM_SweetDreams[3]), Float.parseFloat(ConfigHandler.A_TM_SweetDreams[4]), Integer.parseInt(ConfigHandler.A_TM_SweetDreams[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.SweetDreams);
		SweetMemories = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_SweetMemories[0], Integer.parseInt(ConfigHandler.A_TM_SweetMemories[1]), Integer.parseInt(ConfigHandler.A_TM_SweetMemories[2]), Float.parseFloat(ConfigHandler.A_TM_SweetMemories[3]), Float.parseFloat(ConfigHandler.A_TM_SweetMemories[4]), Integer.parseInt(ConfigHandler.A_TM_SweetMemories[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.SweetMemories);
		Sweetstack = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Sweetstack[0], Integer.parseInt(ConfigHandler.A_TM_Sweetstack[1]), Integer.parseInt(ConfigHandler.A_TM_Sweetstack[2]), Float.parseFloat(ConfigHandler.A_TM_Sweetstack[3]), Float.parseFloat(ConfigHandler.A_TM_Sweetstack[4]), Integer.parseInt(ConfigHandler.A_TM_Sweetstack[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Sweetstack);
		ThreeWishes = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_ThreeWishes[0], Integer.parseInt(ConfigHandler.A_TM_ThreeWishes[1]), Integer.parseInt(ConfigHandler.A_TM_ThreeWishes[2]), Float.parseFloat(ConfigHandler.A_TM_ThreeWishes[3]), Float.parseFloat(ConfigHandler.A_TM_ThreeWishes[4]), Integer.parseInt(ConfigHandler.A_TM_ThreeWishes[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.ThreeWishes);
		TotalEclipse = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_TotalEclipse[0], Integer.parseInt(ConfigHandler.A_TM_TotalEclipse[1]), Integer.parseInt(ConfigHandler.A_TM_TotalEclipse[2]), Float.parseFloat(ConfigHandler.A_TM_TotalEclipse[3]), Float.parseFloat(ConfigHandler.A_TM_TotalEclipse[4]), Integer.parseInt(ConfigHandler.A_TM_TotalEclipse[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.TotalEclipse);
		TreasureTrove = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_TreasureTrove[0], Integer.parseInt(ConfigHandler.A_TM_TreasureTrove[1]), Integer.parseInt(ConfigHandler.A_TM_TreasureTrove[2]), Float.parseFloat(ConfigHandler.A_TM_TreasureTrove[3]), Float.parseFloat(ConfigHandler.A_TM_TreasureTrove[4]), Integer.parseInt(ConfigHandler.A_TM_TreasureTrove[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.TreasureTrove);
		TrueLightsFlight = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_TrueLightsFlight[0], Integer.parseInt(ConfigHandler.A_TM_TrueLightsFlight[1]), Integer.parseInt(ConfigHandler.A_TM_TrueLightsFlight[2]), Float.parseFloat(ConfigHandler.A_TM_TrueLightsFlight[3]), Float.parseFloat(ConfigHandler.A_TM_TrueLightsFlight[4]), Integer.parseInt(ConfigHandler.A_TM_TrueLightsFlight[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.TrueLightsFlight);
		TwilightBlaze = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_TwilightBlaze[0], Integer.parseInt(ConfigHandler.A_TM_TwilightBlaze[1]), Integer.parseInt(ConfigHandler.A_TM_TwilightBlaze[2]), Float.parseFloat(ConfigHandler.A_TM_TwilightBlaze[3]), Float.parseFloat(ConfigHandler.A_TM_TwilightBlaze[4]), Integer.parseInt(ConfigHandler.A_TM_TwilightBlaze[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.TwilightBlaze);
		TwoBecomeOne = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_TwoBecomeOne[0], Integer.parseInt(ConfigHandler.A_TM_TwoBecomeOne[1]), Integer.parseInt(ConfigHandler.A_TM_TwoBecomeOne[2]), Float.parseFloat(ConfigHandler.A_TM_TwoBecomeOne[3]), Float.parseFloat(ConfigHandler.A_TM_TwoBecomeOne[4]), Integer.parseInt(ConfigHandler.A_TM_TwoBecomeOne[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.TwoBecomeOne);
		...
		Unbound = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_Unbound[0], Integer.parseInt(ConfigHandler.A_TM_Unbound[1]), Integer.parseInt(ConfigHandler.A_TM_Unbound[2]), Float.parseFloat(ConfigHandler.A_TM_Unbound[3]), Float.parseFloat(ConfigHandler.A_TM_Unbound[4]), Integer.parseInt(ConfigHandler.A_TM_Unbound[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.Unbound);
		UnicornisForetellersKeyblade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_UnicornisForetellersKeyblade[0], Integer.parseInt(ConfigHandler.A_TM_UnicornisForetellersKeyblade[1]), Integer.parseInt(ConfigHandler.A_TM_UnicornisForetellersKeyblade[2]), Float.parseFloat(ConfigHandler.A_TM_UnicornisForetellersKeyblade[3]), Float.parseFloat(ConfigHandler.A_TM_UnicornisForetellersKeyblade[4]), Integer.parseInt(ConfigHandler.A_TM_UnicornisForetellersKeyblade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.UnicornisForetellersKeyblade);
		UrsusForetellersKeyblade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_UrsusForetellersKeyblade[0], Integer.parseInt(ConfigHandler.A_TM_UrsusForetellersKeyblade[1]), Integer.parseInt(ConfigHandler.A_TM_UrsusForetellersKeyblade[2]), Float.parseFloat(ConfigHandler.A_TM_UrsusForetellersKeyblade[3]), Float.parseFloat(ConfigHandler.A_TM_UrsusForetellersKeyblade[4]), Integer.parseInt(ConfigHandler.A_TM_UrsusForetellersKeyblade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.UrsusForetellersKeyblade);
		VictoryLine = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_VictoryLine[0], Integer.parseInt(ConfigHandler.A_TM_VictoryLine[1]), Integer.parseInt(ConfigHandler.A_TM_VictoryLine[2]), Float.parseFloat(ConfigHandler.A_TM_VictoryLine[3]), Float.parseFloat(ConfigHandler.A_TM_VictoryLine[4]), Integer.parseInt(ConfigHandler.A_TM_VictoryLine[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.VictoryLine);
		VoidGear = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_VoidGear[0], Integer.parseInt(ConfigHandler.A_TM_VoidGear[1]), Integer.parseInt(ConfigHandler.A_TM_VoidGear[2]), Float.parseFloat(ConfigHandler.A_TM_VoidGear[3]), Float.parseFloat(ConfigHandler.A_TM_VoidGear[4]), Integer.parseInt(ConfigHandler.A_TM_VoidGear[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.VoidGear);
		VulpeusForetellersKeyblade = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_VulpeusForetellersKeyblade[0], Integer.parseInt(ConfigHandler.A_TM_VulpeusForetellersKeyblade[1]), Integer.parseInt(ConfigHandler.A_TM_VulpeusForetellersKeyblade[2]), Float.parseFloat(ConfigHandler.A_TM_VulpeusForetellersKeyblade[3]), Float.parseFloat(ConfigHandler.A_TM_VulpeusForetellersKeyblade[4]), Integer.parseInt(ConfigHandler.A_TM_VulpeusForetellersKeyblade[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.VulpeusForetellersKeyblade);
		WaytotheDawn = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_WaytotheDawn[0], Integer.parseInt(ConfigHandler.A_TM_WaytotheDawn[1]), Integer.parseInt(ConfigHandler.A_TM_WaytotheDawn[2]), Float.parseFloat(ConfigHandler.A_TM_WaytotheDawn[3]), Float.parseFloat(ConfigHandler.A_TM_WaytotheDawn[4]), Integer.parseInt(ConfigHandler.A_TM_WaytotheDawn[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.WaytotheDawn);
		WaywardWind = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_WaywardWind[0], Integer.parseInt(ConfigHandler.A_TM_WaywardWind[1]), Integer.parseInt(ConfigHandler.A_TM_WaywardWind[2]), Float.parseFloat(ConfigHandler.A_TM_WaywardWind[3]), Float.parseFloat(ConfigHandler.A_TM_WaywardWind[4]), Integer.parseInt(ConfigHandler.A_TM_WaywardWind[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.WaywardWind);
		WinnersProof = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_WinnersProof[0], Integer.parseInt(ConfigHandler.A_TM_WinnersProof[1]), Integer.parseInt(ConfigHandler.A_TM_WinnersProof[2]), Float.parseFloat(ConfigHandler.A_TM_WinnersProof[3]), Float.parseFloat(ConfigHandler.A_TM_WinnersProof[4]), Integer.parseInt(ConfigHandler.A_TM_WinnersProof[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.WinnersProof);
		WishingLamp = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_WishingLamp[0], Integer.parseInt(ConfigHandler.A_TM_WishingLamp[1]), Integer.parseInt(ConfigHandler.A_TM_WishingLamp[2]), Float.parseFloat(ConfigHandler.A_TM_WishingLamp[3]), Float.parseFloat(ConfigHandler.A_TM_WishingLamp[4]), Integer.parseInt(ConfigHandler.A_TM_WishingLamp[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.WishingLamp);
		WishingStar = new ItemKeyblade(EnumHelper.addToolMaterial(ConfigHandler.A_TM_WishingStar[0], Integer.parseInt(ConfigHandler.A_TM_WishingStar[1]), Integer.parseInt(ConfigHandler.A_TM_WishingStar[2]), Float.parseFloat(ConfigHandler.A_TM_WishingStar[3]), Float.parseFloat(ConfigHandler.A_TM_WishingStar[4]), Integer.parseInt(ConfigHandler.A_TM_WishingStar[5]))).setCreativeTab(tabKingdomKeys).setUnlocalizedName(Strings.WishingStar);
	...
	public static void register () {
		...
		// Armour
		GameRegistry.registerItem(OrganizationRobe_Helmet = new ItemOrganizationRobe(ORGANIZATIONROBE, 1, EntityEquipmentSlot.HEAD, 0, Strings.OrganizationRobe_Helmet), Strings.OrganizationRobe_Helmet);
		GameRegistry.registerItem(OrganizationRobe_Chestplate = new ItemOrganizationRobe(ORGANIZATIONROBE, 1, EntityEquipmentSlot.CHEST, 1, Strings.OrganizationRobe_Chestplate), Strings.OrganizationRobe_Chestplate);
		GameRegistry.registerItem(OrganizationRobe_Leggings = new ItemOrganizationRobe(ORGANIZATIONROBE, 2, EntityEquipmentSlot.LEGS, 2, Strings.OrganizationRobe_Leggings), Strings.OrganizationRobe_Leggings);
		GameRegistry.registerItem(OrganizationRobe_Boots = new ItemOrganizationRobe(ORGANIZATIONROBE, 1, EntityEquipmentSlot.FEET, 3, Strings.OrganizationRobe_Boots), Strings.OrganizationRobe_Boots);

		GameRegistry.registerItem(Terra_Helmet = new ItemTerraArmor(TERRA, 1, EntityEquipmentSlot.HEAD, 0, Strings.Terra_Helmet), Strings.Terra_Helmet);
		GameRegistry.registerItem(Terra_Chestplate = new ItemTerraArmor(TERRA, 1, EntityEquipmentSlot.CHEST, 1, Strings.Terra_Chestplate), Strings.Terra_Chestplate);
		GameRegistry.registerItem(Terra_Leggings = new ItemTerraArmor(TERRA, 2, EntityEquipmentSlot.LEGS, 2, Strings.Terra_Leggings), Strings.Terra_Leggings);
		GameRegistry.registerItem(Terra_Boots = new ItemTerraArmor(TERRA, 1, EntityEquipmentSlot.FEET, 3, Strings.Terra_Boots), Strings.Terra_Boots);

		GameRegistry.registerItem(Aqua_Helmet = new ItemAquaArmor(AQUA, 1, EntityEquipmentSlot.HEAD, 0, Strings.Aqua_Helmet), Strings.Aqua_Helmet);
		GameRegistry.registerItem(Aqua_Chestplate = new ItemAquaArmor(AQUA, 1, EntityEquipmentSlot.CHEST, 1, Strings.Aqua_Chestplate), Strings.Aqua_Chestplate);
		GameRegistry.registerItem(Aqua_Leggings = new ItemAquaArmor(AQUA, 2, EntityEquipmentSlot.LEGS, 2, Strings.Aqua_Leggings), Strings.Aqua_Leggings);
		GameRegistry.registerItem(Aqua_Boots = new ItemAquaArmor(AQUA, 1, EntityEquipmentSlot.FEET, 3, Strings.Aqua_Boots), Strings.Aqua_Boots);

		GameRegistry.registerItem(Ventus_Helmet = new ItemVentusArmor(VENTUS, 1, EntityEquipmentSlot.HEAD, 0, Strings.Ventus_Helmet), Strings.Ventus_Helmet);
		GameRegistry.registerItem(Ventus_Chestplate = new ItemVentusArmor(VENTUS, 1, EntityEquipmentSlot.CHEST, 1, Strings.Ventus_Chestplate), Strings.Ventus_Chestplate);
		GameRegistry.registerItem(Ventus_Leggings = new ItemVentusArmor(VENTUS, 2, EntityEquipmentSlot.LEGS, 2, Strings.Ventus_Leggings), Strings.Ventus_Leggings);
		GameRegistry.registerItem(Ventus_Boots = new ItemVentusArmor(VENTUS, 1, EntityEquipmentSlot.FEET, 3, Strings.Ventus_Boots), Strings.Ventus_Boots);

		GameRegistry.registerItem(Eraqus_Helmet = new ItemEraqusArmor(ERAQUS, 1, EntityEquipmentSlot.HEAD, 0, Strings.Eraqus_Helmet), Strings.Eraqus_Helmet);
		GameRegistry.registerItem(Eraqus_Chestplate = new ItemEraqusArmor(ERAQUS, 1, EntityEquipmentSlot.CHEST, 1, Strings.Eraqus_Chestplate), Strings.Eraqus_Chestplate);
		GameRegistry.registerItem(Eraqus_Leggings = new ItemEraqusArmor(ERAQUS, 2, EntityEquipmentSlot.LEGS, 2, Strings.Eraqus_Leggings), Strings.Eraqus_Leggings);
		GameRegistry.registerItem(Eraqus_Boots = new ItemEraqusArmor(ERAQUS, 1, EntityEquipmentSlot.FEET, 3, Strings.Eraqus_Boots), Strings.Eraqus_Boots);
