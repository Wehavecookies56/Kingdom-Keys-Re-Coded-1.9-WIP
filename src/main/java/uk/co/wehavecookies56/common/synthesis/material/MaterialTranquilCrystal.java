...
public class MaterialTranquilCrystal extends Material {

	String name;

	public MaterialTranquilCrystal (String name) {
		this.name = name;
	}
	...
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/tranquilcrystal.png");
	}
