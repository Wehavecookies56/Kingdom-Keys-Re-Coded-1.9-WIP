...
public class MaterialStormyCrystal extends Material {

	String name;

	public MaterialStormyCrystal (String name) {
		this.name = name;
	}
	...
	public ItemStack getItem () {
		...
		ItemStacks.createSynthesisItem(stack, Strings.SM_StormyCrystal, "S");
		return stack;
	}

	@Override
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/stormycrystal.png");
	}
