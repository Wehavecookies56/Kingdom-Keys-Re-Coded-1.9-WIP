...
public class MaterialBrightStone extends Material {

	String name;

	public MaterialBrightStone (String name) {
		this.name = name;
	}
	...
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/brightstone.png");
	}
