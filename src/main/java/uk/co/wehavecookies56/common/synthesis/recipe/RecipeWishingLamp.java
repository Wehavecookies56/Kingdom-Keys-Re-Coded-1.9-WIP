...
public class RecipeWishingLamp extends Recipe {

	public String name;

	public RecipeWishingLamp (String name) {
		this.name = name;
	}
	...
	public Item getResult () {
		return ModItems.Chain_WishingLamp;
	}
	...
	public Map<Material, Integer> getRequirements () {
		...
		reqs.put(MaterialRegistry.get(Strings.SM_DenseGem), 2);
		return reqs;
	}
