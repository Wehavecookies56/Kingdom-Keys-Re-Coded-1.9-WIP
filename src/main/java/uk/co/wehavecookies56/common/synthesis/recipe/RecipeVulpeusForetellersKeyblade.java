...
public class RecipeVulpeusForetellersKeyblade extends Recipe {

	public String name;

	public RecipeVulpeusForetellersKeyblade (String name) {
		this.name = name;
	}
	...
	public Item getResult () {
		return ModItems.Chain_VulpeusForetellersKeyblade;
	}
