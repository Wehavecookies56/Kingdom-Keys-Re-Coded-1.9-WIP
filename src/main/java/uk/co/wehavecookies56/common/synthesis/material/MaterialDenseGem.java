...
public class MaterialDenseGem extends Material {

	String name;

	public MaterialDenseGem (String name) {
		this.name = name;
	}
	...
	public ItemStack getItem () {
		...
		ItemStacks.createSynthesisItem(stack, Strings.SM_DenseGem, "A");
		return stack;
	}

	@Override
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/densegem.png");
	}
