...
public class MaterialLightningGem extends Material {

	String name;

	public MaterialLightningGem (String name) {
		this.name = name;
	}
	...
	public ItemStack getItem () {
		...
		ItemStacks.createSynthesisItem(stack, Strings.SM_LightningGem, "A");
		return stack;
	}

	@Override
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/lightninggem.png");
	}
