...
public class MaterialTranquilStone extends Material {

	String name;

	public MaterialTranquilStone (String name) {
		this.name = name;
	}
	...
	public ItemStack getItem () {
		...
		ItemStacks.createSynthesisItem(stack, Strings.SM_TranquilStone, "B");
		return stack;
	}

	@Override
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/tranquilstone.png");
	}
