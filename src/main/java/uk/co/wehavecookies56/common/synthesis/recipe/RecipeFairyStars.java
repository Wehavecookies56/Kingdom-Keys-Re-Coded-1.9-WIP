...
public class RecipeFairyStars extends Recipe {

	public String name;

	public RecipeFairyStars (String name) {
		this.name = name;
	}
	...
	public Item getResult () {
		return ModItems.Chain_FairyStars;
	}
	...
	public Map<Material, Integer> getRequirements () {
		...
		reqs.put(MaterialRegistry.get(Strings.SM_BrightShard), 4);
