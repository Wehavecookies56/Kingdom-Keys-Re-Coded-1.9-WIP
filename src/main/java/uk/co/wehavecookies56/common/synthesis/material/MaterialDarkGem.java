...
public class MaterialDarkGem extends Material {

	String name;

	public MaterialDarkGem (String name) {
		this.name = name;
	}
	...
	public ItemStack getItem () {
		...
		ItemStacks.createSynthesisItem(stack, Strings.SM_DarkGem, "A");
		return stack;
	}

	@Override
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/darkgem.png");
	}
