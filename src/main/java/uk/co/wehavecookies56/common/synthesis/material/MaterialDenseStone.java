...
public class MaterialDenseStone extends Material {

	String name;

	public MaterialDenseStone (String name) {
		this.name = name;
	}
	...
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/densestone.png");
	}
