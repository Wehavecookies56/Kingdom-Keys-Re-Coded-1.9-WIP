...
public class RecipeLunarEclipse extends Recipe {

	public String name;

	public RecipeLunarEclipse (String name) {
		this.name = name;
	}
	...
	public Item getResult () {
		return ModItems.Chain_LunarEclipse;
	}
	...
	public Map<Material, Integer> getRequirements () {
		...
		reqs.put(MaterialRegistry.get(Strings.SM_DarkGem), 5);
