package uk.co.wehavecookies56.common.block.tile;
...
public class TileEntitySynthesisBag extends TileEntity implements IInventory {
	...
	public ITextComponent getDisplayName () {
		return hasCustomName() ? new TextComponentString(getDisplayName().toString()) : new TextComponentTranslation(getDisplayName().toString());
	}
