package uk.co.wehavecookies56.common.crafting;
...
public class KKOreDictionary {
	...
	public static void registerOres() {
		...
		//Ores
		registerOre("oreBlazing", ModBlocks.BlazingOre);
		...
		//Records
		registerOre("record", ModItems.Disc_Birth_by_Sleep_A_Link_to_the_Future);
