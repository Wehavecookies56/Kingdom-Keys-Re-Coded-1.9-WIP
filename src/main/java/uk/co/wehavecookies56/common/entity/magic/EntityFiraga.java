...
public class EntityFiraga extends Entity {

	EntityPlayer player;

	public EntityFiraga (World world) {
		super(world);
	}
	...
	public void onUpdate () {
		...
		if (!worldObj.isRemote) PacketDispatcher.sendToAllAround(new SpawnFireParticles(this, 3), player, 64.0D);
