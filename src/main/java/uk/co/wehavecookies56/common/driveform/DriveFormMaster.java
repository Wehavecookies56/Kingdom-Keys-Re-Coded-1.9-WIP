package uk.co.wehavecookies56.common.driveform;
...
public class DriveFormMaster extends DriveForm {
	...
	public void update (EntityPlayer player) {
		...
		if (player.getCapability(ModCapabilities.CHEAT_MODE, null).getCheatMode() == false) if (player.getCapability(ModCapabilities.PLAYER_STATS, null).getDP() > 0) {
