...
import uk.co.wehavecookies56.common.container.ContainerKeychain;
...
public class GuiKeychains extends GuiContainer {
	...
	public GuiKeychains (EntityPlayer player, InventoryPlayer inventoryPlayer, InventoryKeychain inventoryKeychain) {
