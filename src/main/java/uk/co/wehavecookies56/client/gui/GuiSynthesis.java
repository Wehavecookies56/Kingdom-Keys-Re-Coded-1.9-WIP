...
public class GuiSynthesis extends GuiTooltip {
	...
	protected void actionPerformed (GuiButton button) {
		ISynthesisMaterial MATS = mc.thePlayer.getCapability(ModCapabilities.SYNTHESIS_MATERIALS, null);
	...
	public void drawSelected (int mouseX, int mouseY) {
		ISynthesisRecipe RECIPES = mc.thePlayer.getCapability(ModCapabilities.SYNTHESIS_RECIPES, null);
		int posX = 220;
		if (selected != -1) {
			Minecraft.getMinecraft().renderEngine.bindTexture(optionsBackground);
