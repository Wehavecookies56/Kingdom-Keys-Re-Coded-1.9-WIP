...
public class MaterialBrightGem extends Material {

	String name;

	public MaterialBrightGem (String name) {
		this.name = name;
	}
	...
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/brightgem.png");
	}
