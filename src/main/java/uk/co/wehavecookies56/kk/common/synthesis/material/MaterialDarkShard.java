...
public class MaterialDarkShard extends Material {

	String name;

	public MaterialDarkShard (String name) {
		this.name = name;
	}
	...
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/darkshard.png");
	}
