...
public class MaterialMythrilStone extends Material {

	String name;

	public MaterialMythrilStone (String name) {
		this.name = name;
	}
	...
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/mythrilstone.png");
	}
