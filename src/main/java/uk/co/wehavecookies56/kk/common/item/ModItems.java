...
public class ModItems {
	...
	public static void init () {
		...
		// CHAINS
		Chain_AbaddonPlasma = new ItemKeychain((ItemKeyblade) AbaddonPlasma, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_AbaddonPlasma).setCreativeTab(tabKingdomKeys);
		Chain_AbyssalTide = new ItemKeychain((ItemKeyblade) AbyssalTide, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_AbyssalTide).setCreativeTab(tabKingdomKeys);
		Chain_AllforOne = new ItemKeychain((ItemKeyblade) AllforOne, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_AllforOne).setCreativeTab(tabKingdomKeys);
		Chain_AnguisForetellersKeyblade = new ItemKeychain((ItemKeyblade) AnguisForetellersKeyblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_AnguisForetellersKeyblade).setCreativeTab(tabKingdomKeys);
		Chain_AstralBlast = new ItemKeychain((ItemKeyblade) AstralBlast, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_AstralBlast).setCreativeTab(tabKingdomKeys);
		Chain_Aubade = new ItemKeychain((ItemKeyblade) Aubade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Aubade).setCreativeTab(tabKingdomKeys);
		Chain_BondofFlame = new ItemKeychain((ItemKeyblade) BondofFlame, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_BondofFlame).setCreativeTab(tabKingdomKeys);
		Chain_Brightcrest = new ItemKeychain((ItemKeyblade) Brightcrest, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Brightcrest).setCreativeTab(tabKingdomKeys);
		Chain_ChaosRipper = new ItemKeychain((ItemKeyblade) ChaosRipper, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_ChaosRipper).setCreativeTab(tabKingdomKeys);
		Chain_CircleofLife = new ItemKeychain((ItemKeyblade) CircleofLife, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_CircleofLife).setCreativeTab(tabKingdomKeys);
		Chain_Counterpoint = new ItemKeychain((ItemKeyblade) Counterpoint, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Counterpoint).setCreativeTab(tabKingdomKeys);
		Chain_Crabclaw = new ItemKeychain((ItemKeyblade) Crabclaw, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Crabclaw).setCreativeTab(tabKingdomKeys);
		Chain_CrownofGuilt = new ItemKeychain((ItemKeyblade) CrownofGuilt, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_CrownofGuilt).setCreativeTab(tabKingdomKeys);
		Chain_DarkerThanDark = new ItemKeychain((ItemKeyblade) DarkerThanDark, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_DarkerThanDark).setCreativeTab(tabKingdomKeys);
		Chain_Darkgnaw = new ItemKeychain((ItemKeyblade) Darkgnaw, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Darkgnaw).setCreativeTab(tabKingdomKeys);
		Chain_DecisivePumpkin = new ItemKeychain((ItemKeyblade) DecisivePumpkin, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_DecisivePumpkin).setCreativeTab(tabKingdomKeys);
		Chain_DestinysEmbrace = new ItemKeychain((ItemKeyblade) DestinysEmbrace, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_DestinysEmbrace).setCreativeTab(tabKingdomKeys);
		Chain_DiamondDust = new ItemKeychain((ItemKeyblade) DiamondDust, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_DiamondDust).setCreativeTab(tabKingdomKeys);
		Chain_Divewing = new ItemKeychain((ItemKeyblade) Divewing, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Divewing).setCreativeTab(tabKingdomKeys);
		Chain_DivineRose = new ItemKeychain((ItemKeyblade) DivineRose, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_DivineRose).setCreativeTab(tabKingdomKeys);
		Chain_DreamSword = new ItemKeychain((ItemKeyblade) DreamSword, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_DreamSword).setCreativeTab(tabKingdomKeys);
		Chain_DualDisc = new ItemKeychain((ItemKeyblade) DualDisc, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_DualDisc).setCreativeTab(tabKingdomKeys);
		Chain_Earthshaker = new ItemKeychain((ItemKeyblade) Earthshaker, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Earthshaker).setCreativeTab(tabKingdomKeys);
		Chain_EndofPain = new ItemKeychain((ItemKeyblade) EndofPain, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_EndofPain).setCreativeTab(tabKingdomKeys);
		Chain_EndsoftheEarth = new ItemKeychain((ItemKeyblade) EndsoftheEarth, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_EndsoftheEarth).setCreativeTab(tabKingdomKeys);
		Chain_FairyHarp = new ItemKeychain((ItemKeyblade) FairyHarp, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_FairyHarp).setCreativeTab(tabKingdomKeys);
		Chain_FairyStars = new ItemKeychain((ItemKeyblade) FairyStars, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_FairyStars).setCreativeTab(tabKingdomKeys);
		Chain_FatalCrest = new ItemKeychain((ItemKeyblade) FatalCrest, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_FatalCrest).setCreativeTab(tabKingdomKeys);
		Chain_Fenrir = new ItemKeychain((ItemKeyblade) Fenrir, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Fenrir).setCreativeTab(tabKingdomKeys);
		Chain_FerrisGear = new ItemKeychain((ItemKeyblade) FerrisGear, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_FerrisGear).setCreativeTab(tabKingdomKeys);
		Chain_FollowtheWind = new ItemKeychain((ItemKeyblade) FollowtheWind, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_FollowtheWind).setCreativeTab(tabKingdomKeys);
		Chain_FrolicFlame = new ItemKeychain((ItemKeyblade) FrolicFlame, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_FrolicFlame).setCreativeTab(tabKingdomKeys);
		Chain_GlimpseofDarkness = new ItemKeychain((ItemKeyblade) GlimpseofDarkness, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_GlimpseofDarkness).setCreativeTab(tabKingdomKeys);
		Chain_GuardianBell = new ItemKeychain((ItemKeyblade) GuardianBell, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_GuardianBell).setCreativeTab(tabKingdomKeys);
		Chain_GuardianSoul = new ItemKeychain((ItemKeyblade) GuardianSoul, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_GuardianSoul).setCreativeTab(tabKingdomKeys);
		Chain_GullWing = new ItemKeychain((ItemKeyblade) GullWing, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_GullWing).setCreativeTab(tabKingdomKeys);
		Chain_HerosCrest = new ItemKeychain((ItemKeyblade) HerosCrest, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_HerosCrest).setCreativeTab(tabKingdomKeys);
		Chain_HiddenDragon = new ItemKeychain((ItemKeyblade) HiddenDragon, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_HiddenDragon).setCreativeTab(tabKingdomKeys);
		Chain_Hyperdrive = new ItemKeychain((ItemKeyblade) Hyperdrive, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Hyperdrive).setCreativeTab(tabKingdomKeys);
		Chain_IncompleteKiblade = new ItemKeychain((ItemKeyblade) IncompleteKiblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_IncompleteKiblade).setCreativeTab(tabKingdomKeys);
		Chain_JungleKing = new ItemKeychain((ItemKeyblade) JungleKing, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_JungleKing).setCreativeTab(tabKingdomKeys);
		Chain_KeybladeofPeoplesHearts = new ItemKeychain((ItemKeyblade) KeybladeofPeoplesHearts, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_KeybladeofPeoplesHearts).setCreativeTab(tabKingdomKeys);
		Chain_Kiblade = new ItemKeychain((ItemKeyblade) Kiblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Kiblade).setCreativeTab(tabKingdomKeys);
		Chain_KingdomKey = new ItemKeychain((ItemKeyblade) KingdomKey, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_KingdomKey).setCreativeTab(tabKingdomKeys);
		Chain_KingdomKeyD = new ItemKeychain((ItemKeyblade) KingdomKeyD, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_KingdomKeyD).setCreativeTab(tabKingdomKeys);
		Chain_KnockoutPunch = new ItemKeychain((ItemKeyblade) KnockoutPunch, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_KnockoutPunch).setCreativeTab(tabKingdomKeys);
		Chain_LadyLuck = new ItemKeychain((ItemKeyblade) LadyLuck, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_LadyLuck).setCreativeTab(tabKingdomKeys);
		Chain_LeasKeyblade = new ItemKeychain((ItemKeyblade) LeasKeyblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_LeasKeyblade).setCreativeTab(tabKingdomKeys);
		Chain_LeopardosForetellersKeyblade = new ItemKeychain((ItemKeyblade) LeopardosForetellersKeyblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_LeopardosForetellersKeyblade).setCreativeTab(tabKingdomKeys);
		Chain_Leviathan = new ItemKeychain((ItemKeyblade) Leviathan, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Leviathan).setCreativeTab(tabKingdomKeys);
		Chain_Lionheart = new ItemKeychain((ItemKeyblade) Lionheart, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Lionheart).setCreativeTab(tabKingdomKeys);
		Chain_LostMemory = new ItemKeychain((ItemKeyblade) LostMemory, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_LostMemory).setCreativeTab(tabKingdomKeys);
		Chain_LunarEclipse = new ItemKeychain((ItemKeyblade) LunarEclipse, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_LunarEclipse).setCreativeTab(tabKingdomKeys);
		Chain_MarkofaHero = new ItemKeychain((ItemKeyblade) MarkofaHero, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_MarkofaHero).setCreativeTab(tabKingdomKeys);
		Chain_MasterXehanortsKeyblade = new ItemKeychain((ItemKeyblade) MasterXehanortsKeyblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_MasterXehanortsKeyblade).setCreativeTab(tabKingdomKeys);
		Chain_MastersDefender = new ItemKeychain((ItemKeyblade) MastersDefender, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_MastersDefender).setCreativeTab(tabKingdomKeys);
		Chain_MaverickFlare = new ItemKeychain((ItemKeyblade) MaverickFlare, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_MaverickFlare).setCreativeTab(tabKingdomKeys);
		Chain_MetalChocobo = new ItemKeychain((ItemKeyblade) MetalChocobo, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_MetalChocobo).setCreativeTab(tabKingdomKeys);
		Chain_MidnightRoar = new ItemKeychain((ItemKeyblade) MidnightRoar, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_MidnightRoar).setCreativeTab(tabKingdomKeys);
		Chain_MirageSplit = new ItemKeychain((ItemKeyblade) MirageSplit, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_MirageSplit).setCreativeTab(tabKingdomKeys);
		Chain_MissingAche = new ItemKeychain((ItemKeyblade) MissingAche, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_MissingAche).setCreativeTab(tabKingdomKeys);
		Chain_Monochrome = new ItemKeychain((ItemKeyblade) Monochrome, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Monochrome).setCreativeTab(tabKingdomKeys);
		Chain_MysteriousAbyss = new ItemKeychain((ItemKeyblade) MysteriousAbyss, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_MysteriousAbyss).setCreativeTab(tabKingdomKeys);
		Chain_NightmaresEnd = new ItemKeychain((ItemKeyblade) NightmaresEnd, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_NightmaresEnd).setCreativeTab(tabKingdomKeys);
		Chain_NightmaresEndandMirageSplit = new ItemKeychain((ItemKeyblade) NightmaresEndandMirageSplit, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_NightmaresEndandMirageSplit).setCreativeTab(tabKingdomKeys);
		Chain_NoName = new ItemKeychain((ItemKeyblade) NoName, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_NoName).setCreativeTab(tabKingdomKeys);
		Chain_Oathkeeper = new ItemKeychain((ItemKeyblade) Oathkeeper, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Oathkeeper).setCreativeTab(tabKingdomKeys);
		Chain_Oblivion = new ItemKeychain((ItemKeyblade) Oblivion, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Oblivion).setCreativeTab(tabKingdomKeys);
		Chain_OceansRage = new ItemKeychain((ItemKeyblade) OceansRage, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_OceansRage).setCreativeTab(tabKingdomKeys);
		Chain_Olympia = new ItemKeychain((ItemKeyblade) Olympia, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Olympia).setCreativeTab(tabKingdomKeys);
		Chain_OmegaWeapon = new ItemKeychain((ItemKeyblade) OmegaWeapon, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_OmegaWeapon).setCreativeTab(tabKingdomKeys);
		Chain_OminousBlight = new ItemKeychain((ItemKeyblade) OminousBlight, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_OminousBlight).setCreativeTab(tabKingdomKeys);
		Chain_OneWingedAngel = new ItemKeychain((ItemKeyblade) OneWingedAngel, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_OneWingedAngel).setCreativeTab(tabKingdomKeys);
		Chain_PainofSolitude = new ItemKeychain((ItemKeyblade) PainofSolitude, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_PainofSolitude).setCreativeTab(tabKingdomKeys);
		Chain_PhotonDebugger = new ItemKeychain((ItemKeyblade) PhotonDebugger, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_PhotonDebugger).setCreativeTab(tabKingdomKeys);
		Chain_PixiePetal = new ItemKeychain((ItemKeyblade) PixiePetal, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_PixiePetal).setCreativeTab(tabKingdomKeys);
		Chain_Pumpkinhead = new ItemKeychain((ItemKeyblade) Pumpkinhead, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Pumpkinhead).setCreativeTab(tabKingdomKeys);
		Chain_Rainfell = new ItemKeychain((ItemKeyblade) Rainfell, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Rainfell).setCreativeTab(tabKingdomKeys);
		Chain_RejectionofFate = new ItemKeychain((ItemKeyblade) RejectionofFate, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_RejectionofFate).setCreativeTab(tabKingdomKeys);
		Chain_RoyalRadiance = new ItemKeychain((ItemKeyblade) RoyalRadiance, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_RoyalRadiance).setCreativeTab(tabKingdomKeys);
		Chain_RumblingRose = new ItemKeychain((ItemKeyblade) RumblingRose, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_RumblingRose).setCreativeTab(tabKingdomKeys);
		Chain_SignofInnocence = new ItemKeychain((ItemKeyblade) SignofInnocence, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_SignofInnocence).setCreativeTab(tabKingdomKeys);
		Chain_SilentDirge = new ItemKeychain((ItemKeyblade) SilentDirge, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_SilentDirge).setCreativeTab(tabKingdomKeys);
		Chain_SkullNoise = new ItemKeychain((ItemKeyblade) SkullNoise, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_SkullNoise).setCreativeTab(tabKingdomKeys);
		Chain_SleepingLion = new ItemKeychain((ItemKeyblade) SleepingLion, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_SleepingLion).setCreativeTab(tabKingdomKeys);
		Chain_SoulEater = new ItemKeychain((ItemKeyblade) SoulEater, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_SoulEater).setCreativeTab(tabKingdomKeys);
		Chain_Spellbinder = new ItemKeychain((ItemKeyblade) Spellbinder, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Spellbinder).setCreativeTab(tabKingdomKeys);
		Chain_StarSeeker = new ItemKeychain((ItemKeyblade) StarSeeker, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_StarSeeker).setCreativeTab(tabKingdomKeys);
		Chain_Starlight = new ItemKeychain((ItemKeyblade) Starlight, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Starlight).setCreativeTab(tabKingdomKeys);
		Chain_Stormfall = new ItemKeychain((ItemKeyblade) Stormfall, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Stormfall).setCreativeTab(tabKingdomKeys);
		Chain_StrokeofMidnight = new ItemKeychain((ItemKeyblade) StrokeofMidnight, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_StrokeofMidnight).setCreativeTab(tabKingdomKeys);
		Chain_SweetDreams = new ItemKeychain((ItemKeyblade) SweetDreams, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_SweetDreams).setCreativeTab(tabKingdomKeys);
		Chain_SweetMemories = new ItemKeychain((ItemKeyblade) SweetMemories, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_SweetMemories).setCreativeTab(tabKingdomKeys);
		Chain_Sweetstack = new ItemKeychain((ItemKeyblade) Sweetstack, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Sweetstack).setCreativeTab(tabKingdomKeys);
		Chain_ThreeWishes = new ItemKeychain((ItemKeyblade) ThreeWishes, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_ThreeWishes).setCreativeTab(tabKingdomKeys);
		Chain_TotalEclipse = new ItemKeychain((ItemKeyblade) TotalEclipse, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_TotalEclipse).setCreativeTab(tabKingdomKeys);
		Chain_TreasureTrove = new ItemKeychain((ItemKeyblade) TreasureTrove, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_TreasureTrove).setCreativeTab(tabKingdomKeys);
		Chain_TrueLightsFlight = new ItemKeychain((ItemKeyblade) TrueLightsFlight, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_TrueLightsFlight).setCreativeTab(tabKingdomKeys);
		Chain_TwilightBlaze = new ItemKeychain((ItemKeyblade) TwilightBlaze, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_TwilightBlaze).setCreativeTab(tabKingdomKeys);
		Chain_TwoBecomeOne = new ItemKeychain((ItemKeyblade) TwoBecomeOne, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_TwoBecomeOne).setCreativeTab(tabKingdomKeys);
		Chain_UltimaWeaponKH1 = new ItemKeychain((ItemKeyblade) UltimaWeaponKH1, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_UltimaWeaponKH1).setCreativeTab(tabKingdomKeys);
		Chain_UltimaWeaponKH2 = new ItemKeychain((ItemKeyblade) UltimaWeaponKH2, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_UltimaWeaponKH2).setCreativeTab(tabKingdomKeys);
		Chain_UltimaWeaponBBS = new ItemKeychain((ItemKeyblade) UltimaWeaponBBS, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_UltimaWeaponBBS).setCreativeTab(tabKingdomKeys);
		Chain_UltimaWeaponDDD = new ItemKeychain((ItemKeyblade) UltimaWeaponDDD, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_UltimaWeaponDDD).setCreativeTab(tabKingdomKeys);
		Chain_Umbrella = new ItemKeychain((ItemKeyblade) Umbrella, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Umbrella).setCreativeTab(tabKingdomKeys);
		Chain_Unbound = new ItemKeychain((ItemKeyblade) Unbound, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_Unbound).setCreativeTab(tabKingdomKeys);
		Chain_UnicornisForetellersKeyblade = new ItemKeychain((ItemKeyblade) UnicornisForetellersKeyblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_UnicornisForetellersKeyblade).setCreativeTab(tabKingdomKeys);
		Chain_UrsusForetellersKeyblade = new ItemKeychain((ItemKeyblade) UrsusForetellersKeyblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_UrsusForetellersKeyblade).setCreativeTab(tabKingdomKeys);
		Chain_VictoryLine = new ItemKeychain((ItemKeyblade) VictoryLine, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_VictoryLine).setCreativeTab(tabKingdomKeys);
		Chain_VoidGear = new ItemKeychain((ItemKeyblade) VoidGear, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_VoidGear).setCreativeTab(tabKingdomKeys);
		Chain_VulpeusForetellersKeyblade = new ItemKeychain((ItemKeyblade) VulpeusForetellersKeyblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_VulpeusForetellersKeyblade).setCreativeTab(tabKingdomKeys);
		Chain_WaytotheDawn = new ItemKeychain((ItemKeyblade) WaytotheDawn, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_WaytotheDawn).setCreativeTab(tabKingdomKeys);
		Chain_WaywardWind = new ItemKeychain((ItemKeyblade) WaywardWind, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_WaywardWind).setCreativeTab(tabKingdomKeys);
		Chain_WinnersProof = new ItemKeychain((ItemKeyblade) WinnersProof, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_WinnersProof).setCreativeTab(tabKingdomKeys);
		Chain_WishingLamp = new ItemKeychain((ItemKeyblade) WishingLamp, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_WishingLamp).setCreativeTab(tabKingdomKeys);
		Chain_WishingStar = new ItemKeychain((ItemKeyblade) WishingStar, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_WishingStar).setCreativeTab(tabKingdomKeys);
		Chain_YoungXehanortsKeyblade = new ItemKeychain((ItemKeyblade) YoungXehanortsKeyblade, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_YoungXehanortsKeyblade).setCreativeTab(tabKingdomKeys);
		Chain_ZeroOne = new ItemKeychain((ItemKeyblade) ZeroOne, ToolMaterial.DIAMOND).setUnlocalizedName(Strings.Chain_ZeroOne).setCreativeTab(tabKingdomKeys);
