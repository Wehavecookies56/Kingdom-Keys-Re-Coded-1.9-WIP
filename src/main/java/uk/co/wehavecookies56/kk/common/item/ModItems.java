...
public class ModItems {
	...
	// Armour material
	public static ArmorMaterial ORGANIZATIONROBE = EnumHelper.addArmorMaterial("ORGANIZATIONROBE", Reference.MODID + ":organizationrobe", 35, new int[] { 3, 5, 8, 4 }, 15, SoundEvents.item_armor_equip_leather);
	public static ArmorMaterial TERRA = EnumHelper.addArmorMaterial("TERRA", Reference.MODID + ":terra", 35, new int[] { 5, 6, 9, 5 }, 15, SoundEvents.item_armor_equip_iron);
	public static ArmorMaterial AQUA = EnumHelper.addArmorMaterial("AQUA", Reference.MODID + ":aqua", 35, new int[] { 5, 6, 9, 5 }, 15, SoundEvents.item_armor_equip_iron);
	public static ArmorMaterial VENTUS = EnumHelper.addArmorMaterial("VENTUS", Reference.MODID + ":ventus", 35, new int[] { 5, 6, 9, 5 }, 15, SoundEvents.item_armor_equip_iron);
	public static ArmorMaterial ERAQUS = EnumHelper.addArmorMaterial("ERAQUS", Reference.MODID + ":eraqus", 35, new int[] { 5, 6, 9, 5 }, 15, SoundEvents.item_armor_equip_iron);
