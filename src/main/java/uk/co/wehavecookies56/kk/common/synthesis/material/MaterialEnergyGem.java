...
public class MaterialEnergyGem extends Material {

	String name;

	public MaterialEnergyGem (String name) {
		this.name = name;
	}
	...
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/energygem.png");
	}
