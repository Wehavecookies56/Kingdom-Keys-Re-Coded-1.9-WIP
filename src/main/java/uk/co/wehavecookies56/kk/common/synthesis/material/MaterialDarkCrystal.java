...
public class MaterialDarkCrystal extends Material {

	String name;

	public MaterialDarkCrystal (String name) {
		this.name = name;
	}
	...
	public ResourceLocation getTexture () {
		return new ResourceLocation(Reference.MODID, "textures/gui/synthesis/darkcrystal.png");
	}
