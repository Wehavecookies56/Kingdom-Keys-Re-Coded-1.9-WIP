				...
				GL11.glPushMatrix();
				{
					...
					GL11.glPushMatrix();
					{
						...
						GL11.glPushMatrix();
						{
							...
							drawString(mc.fontRendererObj, "LEVEL UP!" + TextFormatting.ITALIC, 0, 0, Color.decode(String.format("#%02x%02x%02x", (byte) Config.interfaceColour[0], (byte) Config.interfaceColour[1], (byte) Config.interfaceColour[2])).hashCode());
						}
						GL11.glPopMatrix();
						GL11.glPushMatrix();
						{
