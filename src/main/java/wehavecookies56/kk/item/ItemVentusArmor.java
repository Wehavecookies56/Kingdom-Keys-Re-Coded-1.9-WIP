...
public class ItemVentusArmor extends ItemArmor implements ISpecialArmor {
	...
	public ItemVentusArmor (ArmorMaterial material, int renderIndex, EntityEquipmentSlot slot, int armorType, String name) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		if (stack.getItem() == ModItems.Ventus_Leggings)
			return Reference.MODID + ":textures/armour/ventus_2.png";
		else
			return Reference.MODID + ":textures/armour/ventus_1.png";
	}
