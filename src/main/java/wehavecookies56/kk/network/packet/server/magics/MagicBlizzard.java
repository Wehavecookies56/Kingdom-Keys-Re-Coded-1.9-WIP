...
public class MagicBlizzard extends AbstractServerMessage<MagicBlizzard> {
	...
	public void process (EntityPlayer player, Side side) {
		if (!Minecraft.getMinecraft().thePlayer.getCapability(KingdomKeys.PLAYER_STATS, null).getCheatMode()) player.getCapability(KingdomKeys.PLAYER_STATS, null).remMP(Constants.getCost(Strings.Spell_Blizzard));
